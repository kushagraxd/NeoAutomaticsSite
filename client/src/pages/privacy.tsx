...
export default function PrivacyPage() {
  usePageMeta('Privacy Policy', 'How Sree Raj Tools handles the information you share through the website enquiry form.');
  ...
  return (
    <>
      <section className="bg-graphite py-14 text-graphite-ink">
        <div className="shell max-w-3xl">
          <span className="accent-rule mb-5" />
          <h1 className="text-[36px] sm:text-[44px]">Privacy Policy</h1>
          <p className="mt-4 text-[16px] text-graphite-muted">
      ...
      <section className="py-14 md:py-20">
        <div className="shell max-w-3xl">
          ...
          <div className="border border-rule bg-surface-subtle p-6">
            <h2 className="text-[20px]">Questions</h2>
