...
export default function ProductsPage() {
  usePageMeta(
    ...
    'Browse carbide inserts by category or search directly by ISO product code. Turning, milling, drilling, grooving and threading inserts, supplied in India and internationally.',
  );
    ...
    <>
      <section className="bg-night py-14 text-night-ink md:py-16">
        <div className="shell">
          ...
          <h1 className="text-h1">Product catalogue</h1>
          <p className="mt-4 max-w-2xl text-[17px] leading-relaxed text-night-muted">
          ...
          <div className="relative mt-8 max-w-xl">
            <Search className="pointer-events-none absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 text-night-muted" aria-hidden="true" />
            ...
            <input
              ...
              className="w-full border border-night-line bg-night-soft py-3.5 pl-12 pr-11 font-mono text-[15px] text-night-ink placeholder:text-night-muted/70 focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent"
            />
            {query && (
              <button
                type="button"
                onClick={() => setQuery('')}
                className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-night-muted hover:text-night-ink"
      ...
      <section className="py-12 md:py-16">
        <div className="shell">
          ...
          {results.length > 0 ? (
            ...
            <div className="rounded-lg border border-rule bg-surface-subtle px-6 py-14 text-center">
              <InsertGlyph category="special" className="mx-auto mb-5 h-16 w-16" />
              <h2 className="text-h3">No listed code matches that search</h2>
