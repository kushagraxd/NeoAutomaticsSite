...
export default function AboutPage() {
  usePageMeta(
    ...
    'ShreeRaj Tools is an India-based importer and supplier of carbide inserts and cutting tools, sourced from established producers in China and Taiwan and supplied to buyers in India and internationally.',
  );
    ...
    <>
      <section className="bg-night py-14 text-night-ink md:py-20">
        <div className="shell max-w-3xl">
          ...
          <h1 className="text-h1">About {company.displayName}</h1>
          <p className="mt-5 text-[18px] leading-relaxed text-night-muted">{company.summary}</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20">
        <div className="shell max-w-3xl">
          ...
          <p className="mt-4 text-[17px] leading-relaxed text-ink-soft">
            We supply carbide inserts and cutting tools to workshops, job shops and manufacturers.
            We are a supplier, not a manufacturer: we source from established producers in{' '}
            {company.sourcingRegions.join(' and ')} and supply against your requirement. We are based
            in {company.basedIn}, serve customers across the country, and welcome enquiries from
          ...
          <h2 className="mt-14 text-h2">How we work</h2>
          <ul className="mt-5 space-y-4">
            {[
              ...
              ['Domestic and export enquiries', 'We quote for customers in India and for buyers abroad. Tell us the destination and we will confirm what we can do.'],
              ...
              <li key={title} className="border-l-2 border-accent-ink pl-5">
          ...
          <h2 className="mt-14 text-h2">Our background</h2>
          <p className="mt-4 text-[17px] leading-relaxed text-ink-soft">
      ...
      <section className="border-t border-rule bg-surface-subtle py-14">
        <div className="shell flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-h2">Start with a requirement</h2>
