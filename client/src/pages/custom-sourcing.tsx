...
export default function CustomSourcingPage() {
  usePageMeta(
    'Custom Sourcing',
    'Send a code, drawing, photograph or sample and Sree Raj Tools will source carbide inserts and cutting tools to your specification from suppliers in China and Taiwan.',
  );
  ...
  return (
    <>
      <section className="bg-graphite py-14 text-graphite-ink md:py-20">
        <div className="shell grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-center">
          <div>
            ...
            <h1 className="text-[38px] sm:text-[50px]">Custom sourcing</h1>
            <p className="mt-5 max-w-xl text-[17px] leading-relaxed text-graphite-muted">
          ...
          <div className="hidden grid-cols-2 gap-3 lg:grid" aria-hidden="true">
            {['Trigon 80°', 'Rhombic 55°', 'Round', 'Rectangular'].map((s) => (
              <div key={s} className="flex aspect-square items-center justify-center border border-graphite-line bg-graphite-light">
      ...
      <section className="py-16 md:py-20">
        <div className="shell">
          <span className="accent-rule mb-5" />
          <h2 className="text-[32px]">What we need from you</h2>
          ...
          <div className="mt-9 grid gap-px border border-rule bg-rule sm:grid-cols-2">
            {INPUTS.map((i) => (
              <div key={i.title} className="bg-white p-7">
                ...
                <h3 className="mt-4 text-[20px]">{i.title}</h3>
      ...
      <section className="border-y border-rule bg-surface-subtle py-16 md:py-20">
        <div className="shell max-w-3xl">
          <span className="accent-rule mb-5" />
          <h2 className="text-[32px]">What we can and cannot promise</h2>
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2">
            <div className="border-l-2 border-accent-strong pl-5">
              <h3 className="text-[19px]">We will</h3>
            ...
            <div className="border-l-2 border-rule pl-5">
              <h3 className="text-[19px]">We will not</h3>
              <ul className="mt-3 space-y-2 text-[15px] leading-relaxed text-ink-soft">
      ...
      <section className="py-14 md:py-20">
        <div className="shell flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-[30px]">Send us the requirement</h2>
