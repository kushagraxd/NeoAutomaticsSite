  ...
  return (
    <>
      <section className="bg-night py-14 text-night-ink md:py-16">
        <div className="shell">
          <nav aria-label="Breadcrumb" className="mb-6 flex items-center gap-1.5 text-[13px] text-night-muted">
          ...
          <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-[17px] leading-relaxed text-night-muted">{category.description}</p>

              {families.length > 0 && (
                <div className="mt-7">
                  <h2 className="label mb-3 text-night-muted">Families in this category</h2>
                  <ul className="flex flex-wrap gap-2">
                    {families.map((f) => (
                      <li key={f} className="border border-night-line px-3 py-1.5 font-mono text-[13px] text-accent">
                        {f}
                      </li>
                    ))}
                  </ul>
            ...
            <div className="hidden shrink-0 items-center justify-center border border-night-line bg-night-soft p-8 md:flex">
        ...
        <div className="shell">
          {items.length > 0 ? (
            ...
            <div className="rounded-lg border border-rule bg-surface-subtle px-6 py-14 text-center">
              ...
              <h2 className="text-h3">Sourced to your requirement</h2>
      ...
      <section className="border-t border-rule bg-surface-subtle py-14">
        <div className="shell flex flex-col items-start gap-5 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-h3">Need a size or grade not listed here?</h2>
